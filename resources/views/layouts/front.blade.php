...
<html lang="pt-BR">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/front.css')}}">
      ...
      <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5NYKF25MHX"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5NYKF25MHX');
</script>
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-K2GV8SBX');</script>
<!-- End Google Tag Manager -->
<body>
    <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K2GV8SBX"
